...
namespace HospitalApp.Migrations
{
    ...
    [Migration("20210713052319_initialeCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HospitalApp.Models.AcountType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HospitalApp.Models.Transaction", b =>
                {
                    ...
                    b.HasOne("HospitalApp.Models.AcountType", "AccountType")
                        .WithMany("Transactions")
                        .HasForeignKey("AccountTypeId")
                        .HasConstraintName("FK_Transactions_AcountType")
                        .IsRequired();

                    b.HasOne("HospitalApp.Models.EntriesSerialize", "SerialNumber")
                        .WithMany("Transactions")
